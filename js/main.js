  ...
  var invJs = {
    ...
    slickSliderActivation: function () {
      $('.testimonial-activation').not('.slick-initialized').slick({
        ...
        fade: true,
        autoplaySpeed: 2000,
        prevArrow: '<button class="slide-arrow next-arrow"><i class="feather-arrow-left"></i></button>',
        nextArrow: '<button class="slide-arrow prev-arrow"><i class="feather-arrow-right"></i></button>'
      });
    ...
    dateUpdate: function () {
      ...
      if (fullYear.length) {
        window.addEventListener("DOMContentLoaded", function () {
          ...
          const [jy] = toJalali(gY, gM, gD);
          document.getElementById("year").textContent = jy;
        });
      }
    },
